...
export default function App() {
  ...
  return (
    <div
      className={`flex h-screen flex-col overflow-hidden bg-slate-50 dark:bg-slate-950 ${dragActive ? 'ring-4 ring-inset ring-indigo-500' : ''}`}
    ...
    >
      <Toaster
        position="top-right"
        toastOptions={{
          className: '!border !border-slate-200 !bg-white !text-slate-800 !shadow-lg dark:!border-slate-700 dark:!bg-slate-800 dark:!text-slate-100',
        }}
      />
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="flex w-1/2 flex-col overflow-hidden border-r border-slate-200 dark:border-slate-700">
          <CodeEditor
            code={code}
            onChange={setCode}
            theme={theme}
